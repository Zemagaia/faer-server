...
public class StaticFileResponse : Response {
    ...
    public StaticFileResponse(RequestContext context, string file, int chunkSize = 1024,
        IEnumerable<KeyValuePair<string, string>> headers = null) : base(context, headers: headers) {
        this.file = file;
