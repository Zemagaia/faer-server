...
public class HttpServer : IDisposable {
    //URI - METHOD
    private List<Tuple<string, string>> handledRoutes = new();
    private HttpListener listener;
    private IScheduler scheduler;
    private IObservable<RequestContext> stream;
    private IDisposable subscription;

    /// <summary>
    ///     Creates a new HTTP Server that listens on a particular port and prefix. Stops listening when Dispose() is called,
    ///     so recommended usage is inside a using() block.
    /// </summary>
    /// <param name="url">
    ///     Prefix URL for web service. Must include a trailing slash. Use e.g. "http://*:5555/" to listen on
    ///     port 5555 for any given hostname.
    /// </param>
    ...
    private IObservable<RequestContext> ObservableHttpContext() {
        var observableHttpContext = Observable.Create<RequestContext>(obs =>
                Observable.FromAsyncPattern(listener.BeginGetContext, listener.EndGetContext)()
    ...
    /// <summary>
    ///     Returns an observable sequence of GET requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    ...
    /// <summary>
    ///     Returns an observable sequence of POST requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of PUT requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of HEAD requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of OPTIONS requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of DELETE requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of TRACE requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of HTTP requests, of any method, that conform to the given URI template, relative to
    ///     the server's prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    ...
    /// <summary>
    ///     Returns an observable sequence of HTTP requests that conform to the given URI template, relative to the server's
    ///     prefix.
    /// </summary>
    /// <param name="uri">A URI template string. See <see cref="UriTemplate.UriTemplate" /> for the template format.</param>
    /// <param name="method">
    ///     The method by which the HTTP request should be called. Pass in upper case. Pass <c>null</c> for
    ///     any method
    /// </param>
    /// <returns>An <c>IObservable</c> to which you should <c>Subscribe()</c></returns>
    public IObservable<RequestContext> OnUriAndMethod(string uri, string method) {
        ...
        var uriTemplate = new UriTemplate.UriTemplate(uri);
