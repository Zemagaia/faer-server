...
public class RequestContext {
    ...
    public virtual Request Request { get; }
    ...
    /// <summary>
    ///     Create a response that can send a UTF-8 encoded string message to the client. Defaults the Content-Type header to
    ///     text/html.
    /// </summary>
    ...
    /// <summary>
    ///     Send an empty response with only the specified HTTP status code. Use <c>Response()</c> to change the content type
    ///     or to set additional headers.
    /// </summary>
    /// <param name="statusCode">HTTP status code</param>
    /// <param name="headers">HTTP headers</param>
    ...
    /// <summary>
    ///     Send a text/html response with the given HTTP status code. Use <c>Response()</c> to change the content type or to
